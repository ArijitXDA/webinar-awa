                ...
                <div key={lead.id} className="px-6 py-4 hover:bg-slate-700/50 transition-colors">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right flex items-center gap-2">
                      ...
                      <button onClick={(e) => { e.stopPropagation(); window.open(`https://wa.me/${lead.country_code.replace('+', '')}${lead.mobile}`, '_blank') }} className="p-2 text-green-400 hover:bg-green-500/20 rounded-lg">
